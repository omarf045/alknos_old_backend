          ...
          <main className="flex flex-1 overflow-hidden">
            <div className="flex flex-col flex-1 overflow-y-auto xl:overflow-hidden">
              ...
              <div className="flex flex-1 xl:overflow-hidden">
                ...
                <nav
                  aria-label="Sections"
                  className="flex-shrink-0 hidden bg-white border-r w-80 border-blue-gray-200 xl:flex xl:flex-col"
                >
                  <div className="flex items-center flex-shrink-0 h-16 px-6 border-b border-blue-gray-200">
                ...
                <div className="flex-1 xl:overflow-y-auto">
                  <div className="max-w-6xl px-4 py-10 mx-auto sm:px-6 lg:py-12 lg:px-8">
                    ...
                    <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:flex md:items-end md:justify-end lg:px-8">
